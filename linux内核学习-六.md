...
![I/O APIC硬件结构](./linux内核学习-六/apic结构.png)
...
![内核执行序列嵌套](./linux内核学习-六/内核执行序列嵌套.png)
...
![硬件处理部分](./linux内核学习-六/intel手册.png)
...
最终的栈布局如下所示
![异常处理的trampoline栈布局](./linux内核学习-六/异常处理的栈布局.png)
...
其I/O中断处理的示意图如下所示
![I/O中断处理流程](./linux内核学习-六/IO中断处理流程.png)
